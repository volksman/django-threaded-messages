...
class Message(models.Model):
    ...
    sender = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='sent_messages', blank=True, null=True, verbose_name=_("sender"))
...
class Thread(models.Model):
    ...
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='created_threads', verbose_name=_("creator"))
...
class Participant(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='threads', verbose_name=_("participant users"))
